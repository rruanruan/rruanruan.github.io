...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    _gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function(t, e) {
        ...
        }, A = /(?:Left|Right|Width)/i, O = /(M11|M12|M21|M22)=[\d\-\.e]+/gi, C = /progid\:DXImageTransform\.Microsoft\.Matrix\(.+?\)/i, D = /,(?=[^\)]*(?:\(|$))/gi, M = Math.PI / 180, z = 180 / Math.PI, I = {}, E = document, F = (E.documentElement,
        E.createElement("div")), L = E.createElement("img"), N = a._internals = {
            _specialProps: o
        ...
        N.CSSPropTween = function(t, e, s, r, a, o, h, l, _, u, p) {
          ...
          , ce = a.parseComplex = function(t, e, i, s, r, n, a, o, h, _) {
            ...
            u = 0; A > u; u++)
                ...
                T = parseFloat(f),
                T || 0 === T)
                    a.appendXtra("", T, ie(g, T), g.replace(d, ""), O && -1 !== g.indexOf("px"), !0);
                    ...
                    p = 0; v.length > p; p++)
                        P = v[p],
                        x = f.indexOf(P, c),
                        a.appendXtra(f.substr(c, x - c), Number(P), ie(y[p], P), "", O && "px" === f.substr(x + P.length, 2), 0 === p),
                        c = x + P.length;
                    a["xs" + a.l] += f.substr(c)
                } else
                    a["xs" + a.l] += a.l ? " " + f : f;
        ...
        var ve = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(",")
          ...
          , Re = N.getTransform = function(t, e, i, s) {
            ...
            if (ye ? n = W(t, Te, e, !0) : t.currentStyle && (n = t.currentStyle.filter.match(O),
            ...
            n && "none" !== n && "matrix(1, 0, 0, 1, 0, 0)" !== n) {
                ...
                h = o.length; --h > -1; )
                    l = Number(o[h]),
                    o[h] = (_ = l - (l |= 0)) ? (0 | _ * x + (0 > _ ? -.5 : .5)) / x + l : l;
                if (16 === o.length) {
                    var R = o[8]
                      , A = o[9]
                      , C = o[10]
                      ...
                      , I = o[13]
                      , E = o[14];
                    if (y.zOrigin && (E = -y.zOrigin,
                    D = R * E - o[12],
                    I = A * E - o[13],
                    E = C * E + y.zOrigin - o[14]),
                    !i || s || null == y.rotationX) {
                        ...
                        $ = V * -U + $ * X,
                        q = L),
                        j && te ? y.rotation = y.rotationX = 0 : j && Y ? y.rotation = y.rotationY = 0 : Y && te && (y.rotationY = y.rotationX = 0),
                        y.scaleX = (0 | Math.sqrt(B * B + q * q) * x + .5) / x,
                        y.scaleY = (0 | Math.sqrt(Z * Z + A * A) * x + .5) / x,
                        y.scaleZ = (0 | Math.sqrt($ * $ + C * C) * x + .5) / x,
                        y.skewX = 0,
                    ...
                    y.x = o[4] || 0,
                    y.y = o[5] || 0,
                    u = Math.sqrt(ie * ie + se * se),
                    p = Math.sqrt(ne * ne + re * re),
                    c = ie || se ? Math.atan2(se, ie) * z : y.rotation || 0,
                    f = re || ne ? Math.atan2(re, ne) * z + c : y.skewX || 0,
                    m = u - Math.abs(y.scaleX || 0),
                    d = p - Math.abs(y.scaleY || 0),
                    Math.abs(f) > 90 && 270 > Math.abs(f) && (T ? (u *= -1,
                    f += 0 >= c ? 180 : -180,
                    c += 0 >= c ? 180 : -180) : (p *= -1,
                    f += 0 >= f ? 180 : -180)),
                    g = (c - y.rotation) % 180,
                    v = (f - y.skewX) % 180,
                    (void 0 === y.skewX || m > w || -w > m || d > w || -w > d || g > -b && b > g && false | g * x || v > -b && b > v && false | v * x) && (y.scaleX = u,
                    y.scaleY = p,
                    y.rotation = c,
                    y.skewX = f),
                    xe && (y.rotationX = y.rotationY = y.z = 0,
                    y.perspective = k,
                    y.scaleZ = 1)
                }
                y.zOrigin = S;
          ...
          , Ae = function(t) {
            ...
            if (p) {
                ...
                u.filter = -1 !== e.indexOf("DXImageTransform.Microsoft.Matrix(") ? e.replace(C, w) : w + " " + e,
          ...
          , Oe = N.set3DTransformRatio = function(t) {
            ...
            if (!(1 !== t && 0 !== t || "auto" !== S.force3D || S.rotationY || S.rotationX || 1 !== C || E || I))
            ...
            if (R || S.skewX)
                ...
                if (!(S.rotationY || S.rotationX || 1 !== C || E || S.svg))
                    return k[ye] = (S.xPercent || S.yPercent ? "translate(" + S.xPercent + "%," + S.yPercent + "%) translate3d(" : "translate3d(") + D + "px," + z + "px," + I + "px)" + (1 !== A || 1 !== O ? " scale(" + A + "," + O + ")" : ""),
                    void 0;
                e = a = 1,
                i = n = 0
            }
            ...
            h = o * c,
            c = u * c + g),
            S.svg && (r += S.xOrigin - (S.xOrigin * e + S.yOrigin * i),
            h += S.yOrigin - (S.xOrigin * n + S.yOrigin * a)),
          ...
          , Ce = N.set2DTransformRatio = function(t) {
            ...
            return !(p.rotationX || p.rotationY || p.z || p.force3D === !0 || "auto" === p.force3D && 1 !== t && 0 !== t) || p.svg && Se || !xe ? (r = p.scaleX,
            n = p.scaleY,
            ...
            p.svg && Se ? c.setAttribute("transform", "matrix(" + _) : f[ye] = (p.xPercent || p.yPercent ? "translate(" + p.xPercent + "%," + p.yPercent + "%) matrix(" : "matrix(") + _) : f[ye] = (p.xPercent || p.yPercent ? "translate(" + p.xPercent + "%," + p.yPercent + "%) matrix(" : "matrix(") + r + ",0,0," + n + "," + m + "," + d + ")",
            void 0) : (this.setRatio = Oe,
            Oe.call(this, t),
            void 0)
        }
        ;
        de("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent", {
            parser: function(t, e, i, s, n, o, h) {
                ...
                p && d.svg ? (ke(t, p, l),
                n = new pe(d,"xOrigin",d.xOrigin,l.xOrigin - d.xOrigin,n,-1,"transformOrigin"),
                n.b = d.xOrigin,
                n.e = n.xs0 = l.xOrigin,
                n = new pe(d,"yOrigin",d.yOrigin,l.yOrigin - d.yOrigin,n,-1,"transformOrigin"),
                n.b = d.yOrigin,
                n.e = n.xs0 = l.yOrigin,
                Me(g, we)) : (p || xe && c && d.zOrigin) && (ye ? (f = !0,
                i = we,
                p = (p || W(t, i, r, !1, "50% 50%")) + "",
                ...
                f && (s._transformType = d.svg && Se || !c && 3 !== this._transformType ? 2 : 3),
                n
            },
            prefix: !0
        }),
        ...
        h._onInitTween = function(t, e, o) {
            ...
            this._transformType) {
                ...
                y.setRatio = T && xe ? Oe : ye ? Ce : Ae,
                y.data = this._transform || Re(t, r, !0),
                n.pop()
            }
            if (i) {
                for (; p; ) {
        ...
        h._enableTransforms = function(t) {
            this._transform = this._transform || Re(this._target, r, !0),
            this._transformType = this._transform.svg && Se || !t && 3 !== this._transformType ? 2 : 3
        }
        ;
        var Ee = function() {
    ...
    if (!i.TweenLite) {
        ...
        var D = g("TweenLite", function(e, i, s) {
          ...
          , z = function(t, e) {
            var i, s = {};
            for (i in t)
                U[i] || i in e && "transform" !== i && "x" !== i && "y" !== i && "width" !== i && "height" !== i && "className" !== i && "border" !== i || !(!L[i] || L[i] && L[i]._autoCSS) || (s[i] = t[i],
                delete t[i]);
            t.css = s
        };
        n = D.prototype = new A,
        ...
        var V = function(t, e, i) {
          ...
          , W = function(t, e, i, s, r) {
            ...
            for (n = r.length; --n > -1; )
                (o = r[n]) === e || o._gc || o._paused || (o._timeline !== e._timeline ? (l = l || Q(e, 0, f),
                0 === Q(o, l, f) && (p[c++] = o)) : u >= o._startTime && o._startTime + o.totalDuration() / o._timeScale > u && ((f || !o._initted) && 2e-10 >= u - o._startTime || (p[c++] = o)));
            for (n = c; --n > -1; )
                o = p[n],
        ...
        Z.activate = function(t) {
            for (var e = t.length; --e > -1; )
                t[e].API === Z.API && (L[(new t[e])._propName] = t[e]);
            return !0
        }
        ,
        d.plugin = function(t) {
